...
Los archivos necesarios para realizar esta parte de la practica se encuentran en la carpeta [full_sumres_display7](lab_sum/full_sumres_display7) de este mismo repositorio.
