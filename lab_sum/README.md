...
1. Para empezar la tabla de verdad de lo que necesitamos, dos entradas de un bit (A y B) y el acarreo (C), si es el primer sumador pues queda en ceros pero para los demás nos importa bastante el valor de este acarreo, las salidas que se requieren son; un dígito del número a sumar (S) y el acarreo para la siguiente suma (Cout).
<center>
...
<center>
  <img src="img/sum_k.png" height="50%" width="50%" >
</center>
<center>
  <img src="img/carry_k.png" height="50%" width="50%" >
</center>
